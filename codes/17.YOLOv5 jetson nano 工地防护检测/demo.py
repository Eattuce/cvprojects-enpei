...
class PPE_detect:
    ...
    def render_frame(self, frame, person_info_list):
        ...
        for person in person_info_list:
            person_box = person[0]
            # person_box: [138.75946044921875 178.2524871826172 609.02099609375 480.0 0.7565838098526001]
            hat_box = person[1]
            vest_box = person[2]
    ...
    def detect(self):
        ...
        while True:
            ...
            # print(f'vest : {vest_list}')
            hat_list = pd[pd['name'].str.contains('helmet')].to_numpy()
            # print(f'hat : {hat_list}')

            # 获取人员信息 w: 包含这个人的衣服和帽子
